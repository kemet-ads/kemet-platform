      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          ...
          <p className="text-base md:text-lg text-zinc-400 leading-relaxed max-w-lg">
            Book a free strategy call. We'll review your current campaigns, identify what's wasting budget, and build a plan to generate more qualified leads at a lower cost.
          </p>
