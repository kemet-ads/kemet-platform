...
const FinalCTA: React.FC = () => {
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden" id="book-call">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-8 text-center">
        ...
        >
          ...
          <p className="text-base md:text-lg text-zinc-400 leading-relaxed max-w-lg">
            Let's review your current campaigns, identify what's wasting budget, and build a strategy that improves performance.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="group px-8 py-4 h-[56px] flex items-center justify-center gap-2 glass-effect-subtle text-zinc-300 font-semibold rounded-full hover:text-white hover:bg-white/[0.06] hover:border-emerald-500/20 transition-all duration-300 active:scale-95 text-[15px]"
            >
