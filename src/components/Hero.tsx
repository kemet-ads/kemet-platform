...
const Hero: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative min-h-screen w-full overflow-hidden bg-[#050e1a] pt-[68px]"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 pt-20 md:pt-28">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            {/* Badge */}
            <motion.div
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-emerald-500/15 bg-emerald-500/[0.04] w-fit"
            ...
            <motion.p
              ...
              animate="visible"
            >
              Meta, Google & TikTok campaigns designed to generate real leads — not just clicks. 
              We help businesses across the UAE reduce wasted ad spend, improve lead quality, 
              and build conversion funnels that drive actual growth.
            </motion.p>
            ...
            >
              <div className="flex flex-wrap gap-8 md:gap-12">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-500 mt-0.5">Qualified Leads Generated</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white">50+</p>
                  <p className="text-[11px] text-zinc-500 mt-0.5">Campaigns Across UAE</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white">3.2x</p>
                  <p className="text-[11px] text-zinc-500 mt-0.5">Average Lead Growth</p>
                </div>
              </div>
              <div className="flex flex-wrap gap-3 mt-4">
                <span className="text-[10px] text-zinc-600">Beauty</span>
                <span className="text-[10px] text-zinc-700">•</span>
                <span className="text-[10px] text-zinc-600">Clinics</span>
                <span className="text-[10px] text-zinc-700">•</span>
                <span className="text-[10px] text-zinc-600">Real Estate</span>
                <span className="text-[10px] text-zinc-700">•</span>
                <span className="text-[10px] text-zinc-600">Gyms</span>
                <span className="text-[10px] text-zinc-700">•</span>
                <span className="text-[10px] text-zinc-600">Restaurants</span>
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative p-8 rounded-2xl bg-white/[0.02] border border-white/[0.06]">
              ...
              <div className="relative z-10 space-y-6">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-semibold tracking-wider text-zinc-500 uppercase">Recent Campaign Results</span>
                </div>
                ...
                <div className="pt-2 flex items-center gap-2 text-[10px] text-zinc-600">
                  <svg className="w-3 h-3 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                  <span>Real client results. Updated weekly.</span>
                </div>
              </div>
            </div>
          </motion.div>
